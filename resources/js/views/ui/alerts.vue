      ...
      <div class="col-xl-6">
        <div class="card">
          <div class="card-body">
            ...
            <b-alert v-model="dismissCountDown" dismissible variant="warning" @close-countdown="countdown = $event">
            ...
            <b-button @click="dismissCountDown = dismissCountDown + 1000" variant="primary" class="m-1">
