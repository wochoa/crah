                            ...
                            <div class="col-xl-6">
                                <div>
                                    ...
                                    <div class="hstack gap-3">
                                        ...
                                        <div class="avatar-md">
                                            <div
                                                class="avatar-title bg-light border-primary border border-top-0 text-center">
                                                <code>.border-top-0</code></div>
                                        </div>
                                        <div class="avatar-md">
                                            <div
                                                class="avatar-title bg-light border-primary border border-end-0 text-center">
                                        ...
                                        <div class="avatar-md">
                                            <div
                                                class="avatar-title bg-light border-primary border border-start-0 text-center">
