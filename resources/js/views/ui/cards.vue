    ...
    <Layout>
        ...
        <div class="row">
            <div class="col-lg-6 col-xl-3">
                <!-- Simple card -->
                <b-card :img-src="img1" img-alt="Card image" img-top>
                    <b-card-title>
            ...
            <div class="col-lg-6 col-xl-3">
                <b-card no-body :img-src="img2" img-alt="Card image" img-top>
                    <b-card-body>
                        <b-card-title>
                            <h5 class="card-title">Card title</h5>
                        </b-card-title>
                        <b-card-text>Some quick example text to build on the card title and make up the bulk of the card's
                            content.</b-card-text>
                    </b-card-body>
            ...
            <div class="col-lg-6 col-xl-3">
                <b-card :img-src="img3" img-alt="Card image" img-top>
                    <b-card-text>
                        Some quick example text to build on the card title and make
                        up the bulk of the card's content.
                    </b-card-text>
            ...
            <div class="col-lg-6">
                <b-card no-body>
                    <b-card-body>
                        ...
                        <a href="javascript:void(0);" class="btn btn-primary w-100">Go somewhere</a>
                    </b-card-body>
                </b-card>
            </div>
            <div class="col-lg-6">
        ...
        <div class="row">
            <div class="col-md-4">
                <b-card header="featured"
                    header-class="card-header bg-transparent border-bottom text-uppercase font-size-16" header-tag="header"
            ...
            <div class="col-md-4">
                <b-card header="Quote" header-class="card-header bg-transparent border-bottom font-size-12"
                    header-tag="header">
                    <b-card-text>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a
                        ante.</b-card-text>
                    <footer>
                        Someone famous in
            ...
            <div class="col-md-4">
                <b-card header="featured"
                    header-class="card-header bg-transparent border-bottom text-uppercase font-size-12" header-tag="header"
                    title="Special title treatment" footer="2 days ago" footer-class="border-top bg-transparent">
                    <b-card-text>
                        <p class="card-text">
        ...
        <div class="row">
            <div class="col-md-4">
                <b-card :img-src="img5" img-alt="Card image" img-top>
                    <b-card-title>
                        <h5 class="card-title">Card title</h5>
                    </b-card-title>
                    <b-card-text>
            ...
            <div class="col-md-4">
                <b-card :img-src="img7" img-alt="Card image" img-bottom>
                    <b-card-title>
                        <h5 class="card-title">Card title</h5>
                    </b-card-title>
                    <b-card-text>
            ...
            <div class="col-md-4">
                <b-card overlay :img-src="img6" img-alt="Card Image" text-variant="white">
                    <b-card-title>
            ...
            <div class="col-lg-6">
                <b-card no-body>
                    <b-row no-gutters class="align-items-center">
                        <b-col md="4">
                            <b-card-img :src="img2" class="rounded-0"></b-card-img>
                        </b-col>
                        <b-col md="8">
                            <b-card-body title="Card title">
                                <b-card-text>This is a wider card with supporting text below as a natural lead-in to
            ...
            <div class="col-lg-6">
                <b-card no-body>
                    <b-row no-gutters class="align-items-center">
                        ...
                        <b-col md="4">
                            <b-card-img :src="img3" class="rounded-0"></b-card-img>
                        </b-col>
                    </b-row>
                </b-card>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <b-card-group>
                    <b-card title="Card title" :img-src="img4" img-alt="Card image" img-top>
                        <b-card-text>This is a longer card with supporting text below as
                            a natural lead-in to additional content. This content is a little
                            bit longer.</b-card-text>
                        <b-card-text>Last updated 3 mins ago.</b-card-text>
                    </b-card>

                    <b-card title="Card title" :img-src="img5" img-alt="Card image" img-top>
                        <b-card-text>This card has supporting text below as a natural
                            lead-in to additional content.</b-card-text>
                        <b-card-text>Last updated 3 mins ago.</b-card-text>
                    </b-card>

                    <b-card title="Card title" :img-src="img6" img-alt="Card image" img-top>
                        <b-card-text>This is a wider card with supporting text below as
                            a natural lead-in to additional content. This card has even longer
                            content than the first to show that equal height action.</b-card-text>
                        <b-card-text>Last updated 3 mins ago.</b-card-text>
                    </b-card>
                </b-card-group>
            </div>
            ...
            <div class="col-sm-12">
                ...
                <div class="row" data-masonry='{"percentPosition": true }'>
                    <div class="col-sm-6 col-lg-4">
                        <b-card no-body :img-src="img3" img-alt="Card image" img-top>
                            <b-card-body title="Card title that wraps to a new line">
                                <b-card-text>This is a longer card with supporting text below as a natural lead-in
                                    to additional content. This content is a little bit longer.</b-card-text>
                            </b-card-body>
                        </b-card>
                    </div>

                    <div class="col-sm-6 col-lg-4">
                        <b-card no-body :img-src="img5" img-alt="Card image" img-top>
                            <b-card-body title="Card title">
                                <b-card-text>This card has supporting text below as a natural lead-in to additional
                                    content.</b-card-text>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <b-card no-body :img-src="img7" img-alt="Card image" img-top>
                        </b-card>
                    </div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <b-card class="bg-primary text-white text-center p-3">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <b-card title="Card title">
                            <b-card-text>This is another card with title and supporting text below. This card
                                has some additional content to make it slightly taller overall.</b-card-text>
