            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mt-4 pt-3">
                        ...
                        <b-form-checkbox id="productdiscountCheck1" value="accepted" unchecked-value="not_accepted" @change="discountLessFilter($event, 10)">Less than 10%</b-form-checkbox>

                        <b-form-checkbox id="productdiscountCheck2" value="accepted" unchecked-value="not_accepted" @change="discountMoreFilter($event, 10)">10% or more</b-form-checkbox>

                        <b-form-checkbox id="productdiscountCheck3" value="accepted" unchecked-value="not_accepted" @change="discountMoreFilter($event, 20)">20% or more</b-form-checkbox>

                        <b-form-checkbox id="productdiscountCheck4" value="accepted" unchecked-value="not_accepted" @change="discountMoreFilter($event, 30)">30% or more</b-form-checkbox>

                        <b-form-checkbox id="productdiscountCheck5" value="accepted" unchecked-value="not_accepted" @change="discountMoreFilter($event, 40)">40% or more</b-form-checkbox>

                        <b-form-checkbox id="productdiscountCheck6" value="accepted" unchecked-value="not_accepted" @change="discountMoreFilter($event, 50)">50% or more</b-form-checkbox>
                    </div>
