                            ...
                            <div class="card-body">
                                ...
                                <form>
                                    ...
                                    <b-row class="mb-4">
                                        ...
                                        <b-col md="10">
                                            <b-form-input id="billing-email-address"
                                    ...
                                    <b-row class="mb-4">
                                        ...
                                        <b-col md="10">
                                            <b-form-input id="billing-phone"
                                                placeholder="Enter your Phone no."></b-form-input>
                                        </b-col>
                                    </b-row>
                                    ...
                                    <b-row class="mb-4">
                                        ...
                                        <b-col md="10">
                                            <b-form-textarea id="billing-address" rows="3"
                                                placeholder="Enter full address"></b-form-textarea>
                                        </b-col>
                                    </b-row>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-md-10">
                                            <select class="form-control select2 select2-hidden-accessible" title="Country"
                                    ...
                                    <b-row class="mb-4">
                                        ...
                                        <b-col md="10">
                                            <b-form-textarea id="example-textarea" rows="3"
                                                placeholder="Write some note.."></b-form-textarea>
                                        </b-col>
                                    </b-row>
                                </form>
                            </div>
                            ...
                            <div class="card-body">
                                <div>
                                    ...
                                    <div>
                                        <div class="custom-control custom-radio custom-control-inline me-4">
                                            ...
                                            <label class="custom-control-label" for="customRadioInline1">
                                                <i class="fab fa-cc-mastercard me-1 font-size-20 align-top"></i> Credit /
                                                Debit Card
                                            </label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline me-4">
                                    ...
                                    <div class="p-4 border">
                                        <form>
                                            <b-form-group id="input-group-2" label="Card Number" label-for="input-card"
                                                class="mb-0">
                                                <b-form-input id="input-card"
                                                    placeholder="0000 0000 0000 0000"></b-form-input>
                                            </b-form-group>

                                            <b-row class="mt-4">
                                                <b-col lg="6">
                                                    <b-form-group id="input-group-2" label="Name on card"
                                                        label-for="input-number" class="mb-0">
                                                        <b-form-input id="input-number"
                                                            placeholder="Name on Card"></b-form-input>
                                                    </b-form-group>
                                                </b-col>
                                                <b-col lg="3">
                                                    <b-form-group id="input-group-2" label="Expiry date"
                                                        label-for="input-date" class="mb-0">
                                                        <b-form-input id="input-date" placeholder="MM/YY"></b-form-input>
                                                    </b-form-group>
                                                </b-col>

                                                <b-col lg="3">
                                                    <b-form-group id="input-group-2" label="CVV Code"
                                                        label-for="cvvcodeInput" class="mb-0">
                                                        <b-form-input id="cvvcodeInput"
                                                            placeholder="Enter CVV Code"></b-form-input>
                                                    </b-form-group>
                                                </b-col>
                                            </b-row>
                                        </form>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-centered mb-0 table-nowrap">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th scope="row">
                                                    <img :src="img1" alt="product-img" title="product-img"
                                                        class="avatar-md" />
                                                </th>
                                                <td>
                                                    <h5 class="font-size-14 text-truncate">
                                                        <a href="/ecommerce/product-detail" class="text-dark">Half sleeve
                                                            T-shirt (64GB)</a>
                                                    </h5>
                                            ...
                                            <tr>
                                                <th scope="row">
                                                    <img :src="img7" alt="product-img" title="product-img"
                                                        class="avatar-md" />
                                                </th>
                                                <td>
                                                    <h5 class="font-size-14 text-truncate">
                                                        <a href="/ecommerce/product-detail" class="text-dark">Wirless
                                                            Headphone</a>
                                                    </h5>
