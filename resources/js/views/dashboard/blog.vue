...
import sm1 from '../../../images/small/img-1.jpg';
import sm2 from '../../../images/small/img-2.jpg';
import sm6 from '../../../images/small/img-6.jpg';
              ...
              <div class="d-flex flex-wrap">
                ...
                <div class="ms-auto">
                  <div class="toolbar button-items text-end">
                    <button type="button" class="btn btn-light me-1 btn-sm" @click="updateData('all')"
                      :class="{ active: selection === 'all' }">
                      ALL
                    </button>
                    <button type="button" class="btn btn-light me-1 btn-sm" @click="updateData('one_month')"
                      :class="{ active: selection === 'one_month' }">
                      1M
                    </button>
                    <button type="button" class="btn btn-light me-1 btn-sm" @click="updateData('six_months')"
                      :class="{ active: selection === 'six_months' }">
                      6M
                    </button>
                    <button type="button" class="btn btn-light btn-sm" @click="updateData('one_year')"
              ...
              <div class="row text-center">
                ...
                <div class="col-lg-4">
                  <div class="mt-4">
                    ...
                    <h5>
                      102354
                      <span class="text-success font-size-13">0.1 % <i class="mdi mdi-arrow-up ms-1"></i></span>
                    </h5>
                  </div>
                </div>
              </div>
              ...
              <div class="d-flex">
                ...
                <div class="flex-grow-1">
                  <div class="d-flex">
                    ...
                    <b-dropdown toggle-class="btn-sm" variant="light" menu-class="dropdown-menu-end" right class="ms-2">
          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex flex-wrap">
                ...
                <b-dropdown toggle-class="text-muted font-size-16 p-0" menu-class="dropdown-menu-end" variant="white"
                  right class="ms-auto">
                  <template #button-content>
          ...
          <div class="card">
            <div class="card-header bg-transparent border-bottom">
              <div class="flex-wrap blog-card">
                ...
                <b-tabs nav-class="nav-tabs-custom card-header-tabs ms-auto" nav-wrapper-class="nav-item" align="right">
                  <b-tab title="Recent" active>
                    <div class="card-body mb-3 mt-2">
                      <simplebar style="max-height: 295px">
                        <ul class="list-group list-group-flush">
                          <li class="list-group-item py-3" v-for="data of postData" :key="data.title">
                            <div class="d-flex">
                              <div class="me-3">
                              ...
                              <b-dropdown class="ms-2" toggle-class="text-muted font-size-14 p-0"
                        ...
                        <ul class="list-group list-group-flush">
                          <li class="list-group-item" v-for="data of postData" :key="data.title">
                            <div class="d-flex">
                              ...
                              <b-dropdown class="ms-2" toggle-class="text-muted font-size-14 p-0" variant="white" right
          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex flex-wrap">
                ...
                <b-dropdown text="Button text via Prop" class="ms-auto" variant="white"
                  toggle-class="p-0 font-size-16 text-muted" menu-class="dropdown-menu-end" right>
                  <template #button-content>
                    <i class="mdi mdi-dots-horizontal"></i>
                  </template>
                  <b-dropdown-item href="#">Action</b-dropdown-item>
                ...
                <ul class="list-group list-group-flush">
                  ...
                  <li class="list-group-item">
                    <div class="py-2">
                      ...
                      <div class="progress animated-progess progress-sm">
                        <div class="progress-bar bg-warning" role="progressbar" style="width: 69%" aria-valuenow="69"
                          aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
                    </div>
                  </li>
                  <li class="list-group-item">
                    <div class="py-2">
                      ...
                      <div class="progress animated-progess progress-sm">
                        <div class="progress-bar bg-success" role="progressbar" style="width: 61%" aria-valuenow="61"
                          aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
                    </div>
                  </li>
          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex">
                ...
                <b-dropdown text="Button text via Prop" toggle-class="text-muted font-size-16 p-0" variant="white" right
                  class="ms-auto" menu-class="dropdown-menu-end">
                  <template #button-content>
                    <i class="mdi mdi-dots-horizontal"></i>
                  </template>
                  <b-dropdown-item href="#">Action</b-dropdown-item>
                  ...
                  <li class="event-list active">
                    ...
                    <div class="d-flex">
                      ...
                      <div class="flex-grow-1">
                        <div>
                          Posted
                          <span class="fw-semibold">Beautiful Day with Friends</span>
                          blog... <a href="#">View</a>
                        </div>
                      </div>
                    </div>
          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex">
                ...
                <b-dropdown text="Button text via Prop" class="ms-auto" variant="white" menu-class="dropdown-menu-end"
                  right>
                  <template #button-content>
                    <i class="mdi mdi-dots-horizontal"></i>
                  </template>
                  ...
                  <tbody>
                    <tr>
                      <td style="width: 100px">
                        <img :src="sm1" alt="" class="avatar-md h-auto d-block rounded" />
                      </td>
                      <td>
                      ...
                      <td>
                        <b-dropdown text="Button text via Prop" toggle-class="text-muted font-size-16 p-0"
                          menu-class="dropdown-menu-end" variant="white" right>
                          <template #button-content>
                            <i class="mdi mdi-dots-horizontal"></i>
                          </template>
                    ...
                    <tr>
                      <td>
                        <img :src="sm6" alt="" class="avatar-md h-auto d-block rounded" />
                      </td>
                      <td>
                        <h5 class="font-size-13 text-truncate mb-1">
                    ...
                    <tr>
                      <td>
                        <img :src="sm2" alt="" class="avatar-md h-auto d-block rounded" />
                      </td>
                      <td>
                        <h5 class="font-size-13 text-truncate mb-1">
