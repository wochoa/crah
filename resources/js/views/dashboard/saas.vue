                            ...
                            <div class="col-lg-4">
                                <div class="text-muted">
                                    <div class="mb-4">
                                        ...
                                        <h4>{{ data.amount }}</h4>
                                        <div>
                                            <span class="badge badge-soft-success font-size-12 mr-1">+ {{ data.revenue
                                            }}%</span>
                                            {{ data.time }}
                                        </div>
                                    </div>
            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div>
                            <apexchart class="apex-charts" :options="ChartData.DonutChart.chartOptions"
                                :series="ChartData.DonutChart.series" dir="ltr" height="240" />
                        </div>
                                    ...
                                    <tbody>
                                        <tr v-for="(item, index) of data.list" :key="index">
                                            ...
                                            <td>
                                                <apexchart :options="
                                                    productChartOptions
                                                " :series="[100, item.sales]" height="80" width="85">
                                                </apexchart>
                                            </td>
                                            <td>
                                ...
                                <b-card-text>
                                    <simplebar style="max-height: 250px">
                                        <div class="table-responsive mb-0">
                                            <table class="table table-nowrap align-mid table-hover ">
                                                <tbody>
                                                    <tr>
                                                        <td style="width: 50px">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5 class="text-truncate font-size-14 mb-1">
                                                                <a href="javascript: void(0);" class="text-dark">New Landing
                                                                    UI</a>
                                                            </h5>
                                                            <p class="text-muted mb-0">
                                                                Assigned to Team
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5 class="text-truncate font-size-14 mb-1">
                                                                <label href="javascript: void(0);" class="text-dark">
                                                                    Blog
                                                                    Template UI
                                                                </label>
                                                            </h5>
                            ...
                            <div class="col-md-8 col-3">
                                <ul class="list-inline user-chat-nav text-end mb-0">
                                    <li class="list-inline-item d-none d-sm-inline-block">
                                        <b-dropdown right menu-class="dropdown-menu-end py-0 dropdown-menu-md"
                                    ...
                                    <li class="list-inline-item d-none d-sm-inline-block">
                                        <b-dropdown toggle-class="nav-btn" menu-class="dropdown-menu-end" right
                                            variant="white">
                                            <template v-slot:button-content>
                                                <i class="bx bx-cog"></i>
                                            </template>
                                ...
                                <div class="position-relative">
                                    ...
                                    <div class="chat-input-links">
                                        <ul class="list-inline mb-0">
                                            <li class="list-inline-item">
                                                <a href="#" data-toggle="tooltip" data-placement="top" title="Emoji"><i
                                                        class="mdi mdi-emoticon-happy-outline"></i></a>
                                            </li>
                                            <li class="list-inline-item">
                                                <a href="#" data-toggle="tooltip" data-placement="top" title="Images"><i
                                                        class="mdi mdi-file-image-outline"></i></a>
                                            </li>
                                            <li class="list-inline-item">
                                                <a href="#" data-toggle="tooltip" data-placement="top" title="Add Files"><i
