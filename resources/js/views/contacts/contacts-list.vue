                    ...
                    <td>
                      <div>
                        <a href="javascript: void(0);"
                          class="badge badge-soft-primary font-size-11 m-1">{{ list.projects[0] }}</a>
                        <a href="javascript: void(0);"
                          class="badge badge-soft-primary font-size-11 m-1">{{ list.projects[1] }}</a>
                        <a href="javascript: void(0);"
                          class="badge badge-soft-primary font-size-11 m-1">{{ list.projects[2] }}</a>
                      </div>
                    </td>
                    <td>125</td>
                    <td>
