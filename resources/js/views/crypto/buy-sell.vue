    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            <div class="float-end">
              <b-dropdown id="dropdown-1" text="Wallet Balance" variant="light" class="m-md-2">
                <template #button-content>
                  <i class="mdi mdi-wallet me-1"></i><span class="btn-light">Wallet Balance <i
                ...
                <b-dropdown-item href="#">BTC : <span class="float-end">1.02356</span></b-dropdown-item>
                <b-dropdown-item href="#"> ETH : <span class="float-end">0.04121</span></b-dropdown-item>
                <b-dropdown-item href="#"> LTC : <span class="float-end">0.00356</span></b-dropdown-item>
                <b-dropdown-divider></b-dropdown-divider>
                <b-dropdown-item href="#" class="text-primary">Learn more</b-dropdown-item>
              </b-dropdown>
              <div>
              </div>
            </div>
                  ...
                  <div class="mb-2">
                    ...
                    <div class="row">
                      <div class="col-xl-2 col-sm-4">
                        <div class="mb-3">
                          <label class="card-radio-label mb-2">
                            <input type="radio" name="currency" id="sellcurrencyoption1" class="card-radio-input"
                              checked />
