...
<template>
  <Layout>
                    ...
                    <td>
                      <ul class="list-unstyled hstack gap-1 mb-0">
                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="View">
                          <a href="/jobs/job-details" class="btn btn-sm btn-soft-primary"><i
                              class="mdi mdi-eye-outline"></i></a>
                        </li>
                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="Delete">
                          <a @click="showModal = !showModal" class="btn btn-sm btn-soft-danger"><i
    ...
    <b-modal v-model="showModal" title-class="text-black font-18" body-class="px-4 py-5 text-center" hide-header hide-footer
      class="v-modal-custom" centered>

        <button type="button" class="btn-close position-absolute end-0 top-0 m-3" @click="showModal = !showModal"></button>
        ...
        <div class="hstack gap-2 justify-content-center mb-0">
          <button type="button" class="btn btn-danger" @click="showModal = !showModal">Delete Now</button>
